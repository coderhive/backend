...
class ComponentService {
    ...
    async createNew(args) {
        let existingTagCheck = await this.componentTagRepository.checkForDuplicateTag(args.tag_id, args.component_id);
        ...
        console.log('inService: ', newTagRelation);
    ...
    async delete(args){
        try{
            ...
            let deletedTagRelationship = await this.componentTagRepository.hardDeleteByTag(tag_id, component_id);
